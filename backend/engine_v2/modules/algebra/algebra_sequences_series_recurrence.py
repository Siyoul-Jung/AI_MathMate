"""
AI_MathMate V2 — algebra_sequences_series_recurrence (Absolute Heritage 91)
"""
...
class AlgebraSequencesSeriesRecurrenceModule(AtomicModule):
    def __init__(self):
        self.META = ModuleMeta(
            ...
            name="Algebra Sequences Series Recurrence",
            domain="algebra",
            namespace="algebra_sequences_series_recurrence",
            input_schema={},
            output_schema={},
            logic_depth=3,
