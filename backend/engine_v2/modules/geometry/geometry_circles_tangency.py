"""
AI_MathMate V2 — geometry_circles_tangency (Absolute Heritage 91)
"""
...
class GeometryCirclesTangencyModule(AtomicModule):
    def __init__(self):
        self.META = ModuleMeta(
            module_id="geometry_circles_tangency",
            name="Geometry Circles Tangency",
            domain="geometry",
            namespace="geometry_circles_tangency",
            input_schema={},
            output_schema={},
            logic_depth=3,
