"""
기댓값 (comb_expected_value)
Domain: combinatorics
Description: 확률 변수가 가질 수 있는 값과 그 값에 해당하는 확률을 곱하여 모두 더한 기댓값을 계산합니다.
"""
from backend.engine_v2.modules.base_module import AtomicModule

class CombExpectedValueModule(AtomicModule):
    def __init__(self):
        super().__init__(
            module_id="comb_expected_value",
            domain="combinatorics",
            logic_depth=4,
